...
public class Jogo {
	...
	public Jogo() {
		...
		Pergunta perg19 = new Pergunta("Qual é o inseto que transmite a doenã de chagas?", "Abelha", "Barata", "Barbeiro", "Pulga", 'c');
	...
	//ainda em dÃºvida se estÃ¡ correto
